...
author:
  ...
  - name: John C. Mallery
    email: jcmallery@gmail.com
  - name: Charles Moorefield
    email: chuck.morefield@icloud.com 
  - name: Sean R. Davis
...
ad %>%
    ...
    dplyr::select(-Accessor, -Geographical, -Geospatial, -Region, -Resolution) %>%
