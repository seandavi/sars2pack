...
link-citations: true  
abstract: |
  Open data resources tracking the nearly real-time global spread of COVID-19 pandemic are the cornerstone of local, national, and international interventions to mitigate public health impacts of the disease. NEED A SENTENCE HERE....
  Here, we present *sars2pack*, a principled, open development, open source software package for accessing and utilizing high-value COVID-19 related data sources from the R statistical programming environment. 
